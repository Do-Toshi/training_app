...
@section('content')
    <div class="flex flex-col items-center mt-10">
        <div class="max-w-md w-full">
            ...
            <form method="POST" action="{{ route('workout_execution') }}" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="number" name="exercise_time_seconds" id="exercise_time_seconds" min="1" max="59" value="0" required class="shadow appearance-none border rounded w-1/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <input type="number" name="rest_time_minutes" id="rest_time_minutes" min="" value="0" required class="shadow appearance-none border rounded w-1/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                        <label for="rest_time_minutes" class="text-gray-700">分</label>
                        
                        <input type="number" name="rest_time_seconds" id="rest_time_seconds" min="1" max="59" value="0" required class="shadow appearance-none border rounded w-1/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
